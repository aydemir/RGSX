...
WebUI (`rgsx_web/handlers.py` `RGSXHandler`, `BaseHTTPRequestHandler` tabanlı arayüz) oyun listelerinde gelişmiş filtreleme destekler. Filtreler oyun listesi sayfasının üstündeki **Filtre** panelinde bulunur.
