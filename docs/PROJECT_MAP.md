...
| Rust gap'leri (Faz 13) | `tasks/gap/TASK-002-gap-{1..11}*.md` | Python iş akışında (PYTHON_WORKFLOW.md) Rust karşılığı OLMAYAN düğümler: retry engine, pause/resume, cancel+temizlik, HTTP-direct, disk alanı, extract, seed lifecycle, stray-temp, restart-resume, history/SSE, 1fichier provider zinciri. P0→P2 sıralı (Faz 13 roadmap) |
